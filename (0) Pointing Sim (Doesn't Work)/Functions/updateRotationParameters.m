...
%       dsiturbanceImpulse = The disturbance impulse for that moment in time
    ...
    function torque = aeroTorque(satellite, unitVelocity, rotationMatrix)
        ...
        %            Uses 1.28 as the coefficent of drag to model Stratus
        ...
        torque = 1/2 * atmosDensity * satellite.linearSpeed^2 * 1.28 * satellite.maxArea * cross(unitVelocity, massToPressure);
    end
